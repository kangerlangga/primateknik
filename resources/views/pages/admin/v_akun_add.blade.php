...
<div class="row">
    ...
    <div class="col-sm-6">
        <div class="form-group">
            ...
            <input class="form-control @error('Nim') is-invalid @enderror" type="nim" name="Nim" value="{{ old('Nim') }}" id="Nim" @error('Nim') aria-describedby="TelpFeedback" @enderror required>
            @error('Nim')
            <div id="TelpFeedback" class="invalid-feedback">{{ $message }}</div>
            @enderror
        </div>
