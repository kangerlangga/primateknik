...
@keyframes animate-preloader {
    ...
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
            ...
            <li><a class="nav-link scrollto active" href="{{ url('berita') }}">Berita</a></li>
  ...
  <main id="main">
    <section id="berita" class="gallery">
        <div class="container" data-aos="fade-up">
          <div class="section-title">
            <h2>{{ $DetailBerita->judul_berita }}</h2>
            <img src="{{  url('') }}/assets/img/berita/{{ $DetailBerita->foto_berita }}" class="img-thumbnail m-3" style="max-width: 50vw; border-radius: 25px;">
            </div>
            <?= $DetailBerita['desk_berita']; ?>
          </div>
        </div>
      </section>
  </main><!-- End #main -->
